...
const shadical = document.getElementById('shadical')
const mcWorld = document.getElementById('mc-world')
const ediMania = document.getElementById('edi-mania')
const chinezi = document.getElementById('chinezi')
const legendaryGuns = document.getElementById('legendary-guns')
const kround = document.getElementById('kround')
...
mcWorld.addEventListener("click", () => {
    dute("istorieMcWorld.html")
})
ediMania.addEventListener("click", () => {
    dute("istorieEDI MANIA.html")
})
chinezi.addEventListener("click", () => {
    alert("Chinezi")
})
legendaryGuns.addEventListener("click", () => {
    alert("Legendary Guns")
})
kround.addEventListener("click", () => {
    dute("istorie[-----KROUND-----].html")
})
shadical.addEventListener("click", () => {
    dute("istorieShadical.html")
})
